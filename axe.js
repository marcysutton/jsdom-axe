        ...
        q.defer(function(res, rej) {
          rule.run(context, options, res, function(err) {
            if (!options.debug) {
              ...
              console.log("canttell", errResult);
              res(errResult);
            } else {
              rej(err);
            }
 ...
 */
  ...
  Audit.prototype._constructHelpUrls = function() {
    var _this = this;
    var previous = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
...
maxstatements: false, maxcomplexity: false */
  ...
  axe._load({
    ...
    rules: [ {
      ...
      tags: [ "wcag2a", "wcag131", "experimental" ],
      all: [ {
        options: {
          margins: [ {
            weight: 150,
   ...
   */
      ...
      color.getBackgroundColor = function(elm) {
        ...
        var noScroll = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
        if (noScroll !== true) {
          elm.scrollIntoView();
        }
        var bgColors = [];
